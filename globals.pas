...
type
  TOptions = record
    sfxvolume,musicvolume:byte; //volume settings
    binding_left,binding_up,binding_down,binding_right, //keyboard bindings
    binding_fire:byte; //keyboard bindings
    difficulty:byte; //difficulty of game.
    GameSeed:Integer; //seed for world generator
    SeedInEffect:Boolean; //was player choose to use constant seed?
    SkinName:String[255];
  end;
